...
<?php				for($i=1;$i<=$total;$i++)	{	?>
						<li><a href="test.php?no=<?php	echo $i;	?>">
<?php						echo $i;	?>
						</a></li>
<?php				}	?>
				</ul></center>
			...
			<div class="col-md-8 col-md-offset-2">
				<div class="row">
					...
					<div class="col-md-2">
	<?php				if(isset($prev)) {		?>
							<a href="test.php?no=<?php echo $prev; ?>">
								<h3 id="previous">
	...
	<?php				} ?>
		...
		<?php		if(isset($next)) {		?>				
						<!--next-->
						<div class="col-md-2 col-md-offset-3">
							<a href="test.php?no=<?php echo $next; ?>">	
								<h3 id="next">
									Next
...
<?php	
	} else echo '<script>	window.location.href = \'test.php?no=1\';	</script>';
